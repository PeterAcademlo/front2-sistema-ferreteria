// components/modals/ModalUpdateProduct.tsx
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl transform transition-all">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-yellow-100">Modifique los datos del producto</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={onSubmit} className="p-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-primary text-white hover:bg-primary/75 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 flex items-center"
            >
